          ...
          <MDBRow>
            <MDBCol lg='3' md='6' className='mb-4 mb-md-0'>
              ...
              <ul className='list-unstyled mb-0'>
                <li>
                  <a href='/addService' className='text-Purple'>
                   Add Services
                  </a>
                </li>
            ...
            <MDBCol lg='3' md='6' className='mb-4 mb-md-0'>
              ...
              <ul className='list-unstyled mb-0'>
                <li>
                  <a href='/addProducts' className='text-Purple'>
                    Add Products
                  </a>
                </li>
            ...
            <MDBCol lg='3' md='6' className='mb-4 mb-md-0'>
             <h3 className='text-uppercase'>Links</h3>
              ...
              <ul className='list-unstyled mb-0'>
                <li>
                  <a href='/showProducts' className='text-Purple'>
                    Show Products
                  </a>
                </li>
            ...
            <MDBCol lg='3'>
              ...
              <ul className='list-unstyled mb-0'>
                <li>
                  <a href='/showServices' className='text-Purple'>
                    Show Services
                  </a>
                </li>
              </ul>
